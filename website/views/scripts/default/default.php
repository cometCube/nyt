                            ...
                            <td class="bundle_col"><?php
                                ...
                                if (is_array($array) || is_object($array)) {
                                    ...
                                    foreach ($array as $value1) {
                                        if ($val->getPlanAttributeName() == $value1->getPlanAttributeName()) {
                                            if ($val->getPlanAttributeName() == "Price There After") {
                                                echo "$" . $value->getPrice();
                                            } else {
...
<section id="faq_section">
    ...
    <div id ="accordian" class ="accordian">
            <?php $count = 1;
            while ($this->block("faqQuesAns")->loop()) {
                $count ++;
                ?>
            <h3>
            <?php echo $this->input('FaqQuest'); ?>
            </h3>
            <div class="content-area-m">
